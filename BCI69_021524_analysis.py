...
folder = r'Z:/2p-raw/BCI69/021424/'
old_folder = r'Z:/2p-raw/BCI69/021324/'
...
plt.subplot(313)
plt.plot(np.dot(df[0:,:],up),'r',linewidth = .05)
plt.plot(-np.dot(df[0:,:],down),'b',linewidth = .05)
#plt.xlim(0,16000)
#%%
