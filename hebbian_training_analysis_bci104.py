...
for epoch_i in range(2):
    ...
    amp = np.nanmean(favg[23:30, :, :], axis=0) - np.nanmean(favg[10:16, :, :], axis=0)
...
amp = np.nanmean(favg_new[23:30, :, :], axis=0) - np.nanmean(favg_new[10:16, :, :], axis=0)
amp2 = np.nanmean(favg_new2[23:30, :, :], axis=0) - np.nanmean(favg_new2[10:16, :, :], axis=0)
scl = .15
offset = 0
