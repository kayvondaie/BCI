function varargout = Photostim_BCI_gui5(varargin)
% PHOTOSTIM_BCI_GUI4 MATLAB code for Photostim_BCI_gui5.fig
...
%      applied to the GUI before Photostim_BCI_gui5_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Photostim_BCI_gui5_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Photostim_BCI_gui5
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @Photostim_BCI_gui5_OpeningFcn, ...
                   'gui_OutputFcn',  @Photostim_BCI_gui5_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Photostim_BCI_gui5 is made visible.
function Photostim_BCI_gui5_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Photostim_BCI_gui5 (see VARARGIN)

% Choose default command line output for Photostim_BCI_gui5
...
% UIWAIT makes Photostim_BCI_gui5 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Photostim_BCI_gui5_OutputFcn(hObject, eventdata, handles) 
