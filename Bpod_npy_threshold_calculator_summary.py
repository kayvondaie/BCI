...
session_inds = np.where((list_of_dirs['Mouse'] == 'BCI93') & (list_of_dirs['Session']=='020325'))[0]
for sii in range(len(session_inds)):
    ...
    name = mouse +'_'+ session + '_behavior_summary'
...
# fig = plt.figure(figsize=(2,2))  # Adjust the width and height as needed
# # plt.plot(x[0:13],np.nanmean(np.asarray(delta_rt)[:,0:13],axis=0),'k.-')
# # plt.xlabel('Trials since Thr change')
# # plt.ylabel('$\Delta$ Time to reward (s)')
# name = mouse +'_'+'_epoch_reward_times'
# folder = 'C:/Users/kayvon.daie/OneDrive - Allen Institute/Documents/Data/Figures 2025/' + name +'.png'
# fig.savefig(folder, format='png')
#%%
