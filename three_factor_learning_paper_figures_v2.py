...
#%% ============================================================================
# CELL 6: Gain-change learning — CN dynamics + behavioral compensation
# Step 1: session_metrics.py — per-session compile (CELL 1, slow network load)
#         + CN late-trial / pre-reward AUC panels and behavioral dose-response.
# Step 2: lickport_speed_analysis.py — miss-clean lickport-speed compensation.
# Output: sm_*.png/.svg  (CN-vs-population, pre-reward AUC over trials /
#                          switch-aligned, dCN-vs-behavior, RT-ratio-vs-alpha,
#                          compensation-fraction box, etc.)
#         compensation_speed_two_panel.png/.svg + lickport_*.png/.svg
# ============================================================================
print("--- Running session_metrics.py (compile + CN/behavior panels) ---")
exec(open(os.path.join(_THIS_DIR, 'session_metrics.py')).read())
print("--- Running lickport_speed_analysis.py (speed compensation) ---")
exec(open(os.path.join(_THIS_DIR, 'lickport_speed_analysis.py')).read())
print("=== CELL 6 done: gain-change neural & behavioral panels ===")
